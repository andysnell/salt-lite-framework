...
namespace PhoneBurner\SaltLite\Framework\Tests\Http\Routing;
...
use PhoneBurner\SaltLite\Framework\Http\Routing\FastRouter as SUT;
...
final class FastRouterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->sut = new SUT(
            Type::of(DefinitionList::class, $this->definition_list),
