...
final class SymfonyNamedKeyFactoryTest extends TestCase
{
    ...
    public static function providesNormalizedKeys(): \Generator
    {
        ...
        yield [SymfonyNamedKey::class . ':1234', 'phone_burner_salt_lite_framework_cache_lock_symfony_named_key_1234'];
        yield [SymfonyNamedKey::class . '.1234', 'phone_burner_salt_lite_framework_cache_lock_symfony_named_key.1234'];
        yield [
