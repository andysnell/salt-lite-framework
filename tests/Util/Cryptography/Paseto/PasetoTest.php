...
use PhoneBurner\SaltLite\Framework\Util\Cryptography\Paseto\Exception\PasetoLogicException;
use PhoneBurner\SaltLite\Framework\Util\Cryptography\Paseto\Paseto;
...
use PhoneBurner\SaltLite\Framework\Util\Cryptography\Paseto\PasetoPurpose;
use PhoneBurner\SaltLite\Framework\Util\Cryptography\Paseto\PasetoVersion;
...
final class PasetoTest extends TestCase
{
    ...
    {
        $key = PasetoKey::fromSeed('3f09f3b08a4c50631b725da2397b4f4e3d976b01681703f4842a22501d6d0f6');
    ...
    public function v2_local_sad_path(): void
    {
        ...
        $paseto->decode(PasetoKey::fromSeed('3f09f3b08a4c50631b725da2397b4f4e3d976b01681703f4842a22501d6d0f7'));
    }
