...
final class X25519Aes256GcmTest extends TestCase
{
    ...
    public function authenticated_encryption_regression_test(): void
    {
        ...
        $ciphertext = CipherText::import(File::get(__DIR__ . '/../../Fixtures/lorem_x25519aes256gcm.txt'));
    ...
    {
        $recipient_keypair = EncryptionKeyPair::import(self::KNOWN_RECIPIENT_KEYPAIR);
        $ciphertext = CipherText::import(File::get(__DIR__ . '/../../Fixtures/lorem_x25519aes256gcm_anonymous.txt'));

        $plaintext = X25519Aes256Gcm::unseal($recipient_keypair, $ciphertext);
    ...
    public function anonymous_encryption_happy_path(): void
    {
        ...
        $ciphertext = X25519Aes256Gcm::seal($recipient_keypair->public, self::MESSAGE);
        $plaintext = X25519Aes256Gcm::unseal($recipient_keypair, $ciphertext);
