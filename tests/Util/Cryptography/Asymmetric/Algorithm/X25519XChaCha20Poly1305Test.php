...
final class X25519XChaCha20Poly1305Test extends TestCase
{
    ...
    public function encryption_happy_path(): void
    {
        ...
        $ciphertext = X25519XChaCha20Poly1305::encrypt($sender_keypair, $recipient_keypair->public, self::MESSAGE);
        $plaintext = X25519XChaCha20Poly1305::decrypt($recipient_keypair, $sender_keypair->public, $ciphertext);
        ...
        self::assertNotSame($ciphertext, X25519XChaCha20Poly1305::encrypt(
            $sender_keypair,
    ...
    public function authenticated_encryption_regression_test(): void
    {
        ...
        $ciphertext = CipherText::import(File::get(__DIR__ . '/../../Fixtures/lorem_x25519xchacha20poly1305.txt'));
    ...
    {
        $recipient_keypair = EncryptionKeyPair::import(self::KNOWN_RECIPIENT_KEYPAIR);
        $ciphertext = CipherText::import(File::get(__DIR__ . '/../../Fixtures/lorem_x25519xchacha20poly1305_anonymous.txt'));

        $plaintext = X25519XChaCha20Poly1305::unseal($recipient_keypair, $ciphertext);
    ...
    public function anonymous_encryption_happy_path(): void
    {
        ...
        $ciphertext = X25519XChaCha20Poly1305::seal($recipient_keypair->public, self::MESSAGE);
        $plaintext = X25519XChaCha20Poly1305::unseal($recipient_keypair, $ciphertext);
    ...
    public function aead_happy_path(): void
    {
        ...
        $ciphertext = X25519XChaCha20Poly1305::encrypt(
            $sender_keypair,
            $recipient_keypair->public,
            self::MESSAGE,
        ...
        $plaintext = X25519XChaCha20Poly1305::decrypt(
            $recipient_keypair,
