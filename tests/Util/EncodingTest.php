...
final class EncodingTest extends TestCase
{
    ...
    {
        self::assertSame('hello', Encoding::Hex->decode('hex:68656c6c6f'));
        self::assertSame('hello', Encoding::Hex->decode('0x68656c6c6f'));
        self::assertSame('hello', Encoding::Hex->decode('hex:0x68656c6c6f'));
    }
}
