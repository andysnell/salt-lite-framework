...
final readonly class Hash implements MessageDigest
{
    ...
    public function __construct(
        ...
        try {
            $this->digest = $encoding ? $encoding->decode($digest) : $digest;
        } catch (\Exception $e) {
    ...
    public static function make(
        ...
        ConstantTimeEncoding $encoding = ConstantTimeEncoding::Hex,
    ): self {
    ...
    {
        return $encoding->encode($this->digest);
    }
    ...
    {
        return $this->digest(ConstantTimeEncoding::Hex);
    }
