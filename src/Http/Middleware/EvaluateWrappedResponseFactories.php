 ...
 * queue, but after the `PhoneBurner\SaltLite\Framework\Http\Middleware\TransformHttpExceptionResponses`
 * and `PhoneBurner\SaltLite\Framework\Http\Middleware\CatchExceptionalResponses`
