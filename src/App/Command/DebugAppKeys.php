...
class DebugAppKeys extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        $encoding = match ($input->getOption('encoding') ?? 'base64') {
            'base64' => ConstantTimeEncoding::Base64,
            'base64url' => ConstantTimeEncoding::Base64Url,
            'hex' => ConstantTimeEncoding::Hex,
    ...
    private function displaySecretKeys(OutputInterface $output, ConstantTimeEncoding $encoding): void
    {
        ...
        $output->writeln('Secret: <fg=red>' . $encryption->secret->export($encoding) . "</>");
    ...
    private function displayPublicKeys(OutputInterface $output, ConstantTimeEncoding $encoding): void
    {
